...
//
//     const mainPage = useMemo(()=><div ref={ref} className={"maxSize"} style={{height:"100vh",overflow: "auto", scrollbarWidth: "none", scrollBehavior: "smooth", scrollSnapType: "y mandatory"}}>
...
//                     tt(ww.current ? ww.current.width * -1 : -300)
//                 }
...
//                     }
//                 }}
//                 style={{position: "absolute", left: `calc(100% + ${x}px)`, zIndex, //width: `calc(100vw - ${50}px)`//overflow: "scroll"
//                 }}>
//                 {mainPage}
//                 {/*{page}*/}
//             </div>
...
//         return <div className={"blur"} style={{minHeight: "100vh", width: w > 800 ? "45vw" : "calc(100vw - 50px)",  background: color, position:"relative",
//             // overflow: "scroll"
//         }}>
...
//
// ApiLeftMenu.setMenu([
//     {button: <div>1</div>, el: () => <div>1</div>, color: "rgb(92,50,213)"},
//     {button: <div>2</div>, el: () => <div>2</div>},
// ], "test")
// export function TestLeft22() {
