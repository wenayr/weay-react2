// agGrid4 usage samples. QA/doc only - lives under src/stand/, not compiled into the library.
import React, { useEffect } from 'react'
import type { ColDef } from 'ag-grid-community'
import { useAgGrid, AgGridTable, type BufferTable } from '../internal/grid/agGrid4/index.js'
