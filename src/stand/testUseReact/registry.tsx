...
import { Card60 } from './cards/videoCallLabels.js';
...
export const qaCards: QaCard[] = [
    { id: 'video-call-labels', n: 60, section: 'active', title: 'VideoCall — interface language (labels)', tall: true, Component: Card60 },
