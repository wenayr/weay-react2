...
export function Card9() {
    ...
    <Check n={9} title="Logs - time format + MiniLogs layers"
                       ...
                       note="This card mounts logsApi.React.Message; that compatibility wrapper now uses useMessageEventLogsController -> MessageEventLogsView.  MiniLogs is hook/controller-first: useMiniLogsTable -> MiniLogsView/MiniLogsTable -> compatibility MiniLogs."
                       tall>
                    <LogsDemo />
                </Check>
    );
